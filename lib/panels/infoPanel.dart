          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  Text('TANYA JAWAB',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 18),),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: <Widget>[
                  Text('DONASI',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 18),),
                  Icon(Icons.arrow_forward,color: Colors.white,)
                ],
              ),
            ),
