...
import 'package:covid19/pages/countyPage.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  fetchCountryData() async {
    http.Response response =
        await http.get(Uri.parse('https://corona.lmao.ninja/v2/countries?sort=deaths'));
    setState(() {
      ...
      body: RefreshIndicator(
        ...
        child: SingleChildScrollView(
          ...
          children: <Widget>[
            ...
            Center(
              child: Text(
                'UNIVERSITAS GUNADARMA PARTICIPATION',
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
              )),
            SizedBox(
              height: 10,
